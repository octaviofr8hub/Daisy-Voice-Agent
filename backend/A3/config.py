...
WAKE_WORDS = {"hola", "bueno", "quién es", "quien es", "daisy", "que no", "qué no", "sí"}
'''
# Field definitions
FIELDS = [
    ("nombre_operador", "nombre completo"),
    ("numero_tractor", "número de tractor"),
    ("placas_tractor", "placas del tractor"),
    ("numero_trailer", "número de tráiler"),
    ("placas_trailer", "placas del tráiler"),
    ("eta", "ETA")
]

FIELD_ORDER = [field[0] for field in FIELDS]
NUM_FIELDS = len(FIELDS)