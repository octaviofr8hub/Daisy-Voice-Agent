...
PERMISSION_MESSAGE = """
Clasifica la intención del usuario respecto a continuar con la llamada. Categorías: aceptar_llamada, rechazar_llamada, pedir_correo, pedir_whatsapp, reagendar_llamada, esperar_minutos. Devuelve solo la categoría.
Ejemplos:
